  ...
  <div id="app">
    ...
    <div class="blogDetailsPage">
      ...
      <div class="blogDetailsPage__banner">
        <img src="./assets/bannerBlogDetails.svg" alt="banner" class="blogDetailsPage__banner__img">
      </div>
        ...
        <div class="blogDetailsPage__center__main">
          <div v-if="selectedArticleByTag" class="selected-article">
            ...
            <div>
              ...
              <div class="blogDetailsPage__center__slogan-container"><img class="blogDetailsPage__center__slogan"
                  :src="selectedArticleByTag.content.sloganImg" alt="Slogan Image"></div>
          ...
          <div class="article" v-for="article in filteredArticles" :key="article.title">
            ...
            <div v-if="article !== selectedArticleByTag">
    ...
    <TagList :tags="tags" />
    <ArticleList :articles="articles" @select-article="selectArticle" />
...
export default {
  ...
  data() {
    return {
      articles: [
        {
          ...
          content: {
            image: './assets/BlogDetailsArt1.svg',
            ...
            sloganImg: './assets/BlogDetailsSlogan.svg',
            ...
            secondImage: './assets/BlogDetailsArt2.svg',
      ...
      tags: ['Kitchen', 'Kitchen planning', 'Bedroom', 'Building', 'Architecture'],
